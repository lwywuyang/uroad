...
<head>
    ...
    var id='<?php echo $id ?>'; 
        ...
        function Refash(){
            ...
            JAjax('admin/Organization/BusiDataPerLogic','RefashData',{BuTable:buTable,DisFiledID:disFiledID,DisFiledF:disFiledF,DisFiledS:disFiledS,SelfLinkFiled:selfLinkFiled,FrFiled:frFiled,BuID:id,DataTypeCode:DataTypeCode},function (data){
                    if(data.Success)
                    {
                       // 刷新页面
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body form-horizontal">
            <div class="form-group">
                ...
                <div class="col-xs-3">
                    <input name="DataTypeCode" type="text" value='<?php echo $BUData[0]['DataTypeCode'];?>' maxlength="10" readonly="readonly" id="DataTypeCode" NotNull="true" class="form-control" />
                </div>
