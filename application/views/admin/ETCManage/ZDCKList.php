        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-hover table-bordered dataTable" id="dataGrid">
                    <thead>
                        <tr>
                            <th class="title" width="" itemvalue="ordernum">订单号
                            </th>
                            <th class="title" width="" itemvalue="payno">支付单号
                            </th>
                            <th class="title" width="" itemvalue="payamount">支付金额
                            </th>
                            ...
                            <th class="title" width="" itemvalue="money">金额
                            </th>
                            <th class="title" width="" itemvalue="cardno">卡号
                            </th>
                            <th class="title" width="" itemvalue="createtime" showformat="yyyy-MM-dd hh:mm:ss">下单时间
                            </th>
                        </tr>
                    </thead>
                    <tbody></tbody>
...
<script type="text/javascript" language="javascript">
    ...
    function Load(t) {
        ...
        JAjax("admin/ETCManage/ZDCKLogic", 'onLoadZDCK', {page:t,StartTime:StartTime,EndTime:EndTime,keyword:keyword}, function (data) {
