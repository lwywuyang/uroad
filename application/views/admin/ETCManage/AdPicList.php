...
<script type="text/javascript" language="javascript">
    ...
    function Load(t) {
        ...
        JAjax("admin/ETCManage/AdPicLogic", 'onLoadAdPic', {page:t,StartTime:StartTime,EndTime:EndTime,stateSel:stateSel}, function (data) {
    ...
    Load(0);
     ...
     function detail(id) {
        showLayerPageJs("<?php echo base_url('/index.php/admin/ETCManage/AdPicLogic/detailAdPic') ?>?id="+id, '网点信息', 750, 500, reLoad);
    }


    function changeState(id,state) {

        JAjax("admin/ETCManage/AdPicLogic", 'setNewState', {id:id,state:state}, function (data) {
            if(data.Success)
                Load(page);
            else
