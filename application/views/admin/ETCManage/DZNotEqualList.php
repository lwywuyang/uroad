                ...
                <table class="table table-hover table-bordered dataTable" id="dataGrid">
                    <thead>
                        <tr>
                            ...
                            <th class="title" width="" itemvalue="phone">手机号
                            </th>
                            <th class="title" width="" itemvalue="orderno">订单号
                            </th>
                            <th class="title" width="80px" itemvalue="statusname">订单状态
                            </th>
                            <th class="title" width="" itemvalue="ordertime" showformat="yyyy-MM-dd hh:mm:ss">下单时间
                            </th>
                            <th class="title" width="80px" itemvalue="paytypename">支付类型
                            </th>
                            <th class="title" width="100px" itemvalue="price">金额
                            </th>
...
<script type="text/javascript" language="javascript">
    ...
    function Load(t) {
        ...
        JAjax("admin/ETCManage/DZNotEqualLogic", 'onLoadDZNotEqual', {page:t,StartTime:StartTime,EndTime:EndTime,keyword:keyword}, function (data) {
