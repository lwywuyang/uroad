...
<head>
    ...
    <script type="text/javascript">
        ...
        var cardno = '<?php echo isset($cardno)?$cardno:"" ?>';
        //设置下拉框默认值为站点属性值
//        $().ready(function(){
//            //alert(poiid);
//            if (poiid != 0) {
...
//        });
        ...
        function submit(){
            ...
            if (type == 'add') {//新增
                JAjax("admin/ETCManage/CheckPendingLogic", 'saveNewCheckPendingMsg', {content:content}, function (data) {
                    if (data.data == true) {
                ...
                JAjax("admin/ETCManage/CheckPendingLogic", 'saveCheckPendingMsg', {cardno:cardno,content:content}, function (data) {
                    //alert(data.data);
                    if (data.data == true) {
                        alert('新增成功');closeLayerPageJs();
                    }else{
...
<div class="panel panel-default form-horizontal ">
    ...
    <div class="panel-footer">
        ...
        <input type="button" value="保存" class="btn btn-info" style="margin-right: 15px;" onclick="submit();" />
    </div>
 </div>
</body>
</html>