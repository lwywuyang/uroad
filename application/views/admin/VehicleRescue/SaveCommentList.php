...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Load(t) {
            ...
            JAjax("admin/VehicleRescue/SaveCommentLogic", 'onLoadSaveComment', {page:page,search:search}, function (data) {
         ...
         * @desc 打开'新增设备'页面
         */
        function operateSaveComment(id){
            showLayerPageJs("<?php echo base_url('/index.php/admin/VehicleRescue/SaveCommentLogic/operateSaveCommentMsg') ?>?id="+id,'详情',550,560,reLoad);
        }
        ...
        function deleteSaveComment(){
            //获取选中选框,属性的name元素,dataGrid上下文对象
            var values = getAllCheckedValues("rpcheckbox", "#dataGrid");

            if (values != "" && values != undefined) {
                ShowConfirm("您确定要删除吗?", function () {
                    JAjax("admin/VehicleRescue/SaveCommentLogic", "delSaveComment", { deleteValue: values}, function (data) {
                        if (data.Success)
                            reLoad();
                        else
    ...
    <div class="panel panel-default" id="content_list">
        <div class="panel-heading">
            <div class="form-inline mb10">
                ...
                <!-- <div class="form-group">
                    <input type="button" value="新 增" id="new" onclick="operateSaveComment(0);" class="btn btn-info" >
                </div>
                <div class="form-group">
                    <input type="button" value="删 除" id="del" onclick="deleteSaveComment();" class="btn btn-danger">
                </div> -->
            </div>
        </div>
                ...
                <table class="table mb30 table-hover table-bordered dataTable" id="dataGrid">
                    <thead>
                        <tr>
                            ...
                            <th class="title" width="" itemvalue="nickname" center="true">用户名
                            </th>
                            <th class="title" width="" itemvalue="name" center="true">中队/大队名称
                            </th>
                            <th class="title" width="" itemvalue="address" center="true">救援地点
                            </th>
                            <th class="title" width="" itemvalue="content" center="true">评价内容
                            </th>
                            <th class="title" width="" itemvalue="star" center="true">评价星级
                            </th>
                            <th class="title" width="" itemvalue="phone" center="true">电话
                            </th>
                            <th class="title" width="" itemvalue="inittime" center="true" showformat="yyyy-MM-dd hh:mm:ss">评价时间
                            </th>
