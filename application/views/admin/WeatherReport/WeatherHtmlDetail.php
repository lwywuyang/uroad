...
<script src="<?php echo base_url('/asset/plugs/angular-upload/controllersHtml.js?15915') ?>"></script>
<script type="text/javascript">
    ...
    function submitDetail(){
        ...
        JAjax('admin/News/NewsLogic','saveWeather',{id:id,newstype:newstype,title:title,html:html,jpgurl:jpgurl},function (data){
            if(data.Success){
                ShowMsg('操作成功!');
                closeLayerPageJss();
            }else
