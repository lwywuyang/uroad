        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table class="table mb30 table-hover table-bordered dataTable" id="dataGrid">
                    <thead>
                        <tr>
                            <th class="title" width="10%" itemvalue="title" center="true">问题
                            </th>
                            <th class="title" width="5%" itemvalue="questiontype" center="true">类型
                            </th>
                            <th class="title" width="25%" itemvalue="answer" center="true">回复
                            </th>
                            <th class="title" width="20%" itemvalue="keyword" center="true">关键字
                            </th>               
                            <th class="title" width="20%" itemvalue="operate" center="true">相关操作
                            </th>
                        </tr>
                    </thead>
                    <tbody>
