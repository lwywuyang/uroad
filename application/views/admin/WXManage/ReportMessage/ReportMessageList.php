...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Load(t) {
            ...
            JAjax("admin/WXManage/ReportMessageLogic", 'onLoadReportMsg', {page:page,startTime:startTime,endTime:endTime,keyword:keyword,typeSel:typeSel}, function (data) {
                ...
                <table class="table table-hover table-bordered dataTable" id="dataGrid">
                    <thead>               
                        <tr>
                            ...
                            <th class="title" width="65px" itemvalue="typeName" center="true">事件类型
                            </th>
                            <th class="title" width="10%" itemvalue="nickname" center="true">用户
                            </th>
                            <th class="title" width="8%" itemvalue="occplace" center="true">爆料位置
                            </th>
                            <th class="title" width="20%" itemvalue="occtime" center="true" showformat="yyyy-MM-dd hh:mm:ss">爆料时间
                            </th>
                            <th class="title" width="8%" itemvalue="remark" center="true">爆料信息 
                            </th>
                            <!-- <th class="title" width="8%" itemvalue="" center="true">状态
                            </th>
                            <th class="title" width="8%" itemvalue="" center="true">来源
                            </th> -->
                            <th class="title" width="8%" itemvalue="photo" center="true">现场照片
                            </th>
                            <th class="title" width="60px" itemvalue="operate" center="true">操作 
                            </th>
                        </tr>
                    </thead>
                    <tbody>
