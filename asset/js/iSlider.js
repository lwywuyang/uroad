...
iSlider.prototype={
	...
	init:function () {
        ...
        this.index = ((this.opts.lastLocate && lastLocateIndex>=0) ? lastLocateIndex : 0) || this.opts.index || 0;   //后退回来的时候 定位到这一页*/
        if (!this.wrap) {
...
//        var nextIndex = this.index+1 > this.length-1 ? 0 : this.index+1;
        ...
        setTimeout(function () {
            ...
            self.addClass(self._current,self.opts.playClass)
            console.log(self.opts.playClass);
            try {
                self.opts.onslide.call(self,self.index);
            } catch (e) {
//                console.info(e)
...
function change(index){
        ...
        switch(index){
                case 0:
                    $('.wrap .home_main').height(mh*0.67);
                    $('.wrap .home_main').css({left:(mw-mh*0.7*640/700)/2});
                    $('.wrap .home_bottom').height(mh*0.17);
                    $('.wrap .home_bottom').css({left:(mw-mh*0.17*640/159)/2});
                break;
                case 1:
                     /*流程页*/
                    $('.wrap .P2_bg').height(mh*0.9);
                    $('.wrap .P2_bg').css({left:(mw-mh*0.9*640/858)/2,top:mh*0.09});
                break;
                case 2:
                    /*投票页*/
                    $('.wrap .page2 ul').width(mw*0.82).height(mh*0.76);
                    $('.wrap .page2 ul').css({left:mw*0.09,top:mh*0.1});
                    $('.wrap .P3_li').width(mw*0.41).height(mh*0.38);
                    $('.wrap .P3_li .P3_photo').height(mh*0.2);
                    $('.wrap .P3_li .P3_photo').css({left:(mw*0.41-mh*0.2*184/217)/2});
                    $('.wrap .P3_li .P3_num').width(mw*0.35).height(mh*0.03);
                    $('.wrap .P3_li .P3_num').css({left:(mw*0.41-mw*0.35)/2,top:mh*0.21});
                    $('.wrap .P3_li .P3_program').width(mw*0.4).height(mh*0.03);
                    $('.wrap .P3_li .P3_program').css({left:(mw*0.41-mw*0.4)/2,top:mh*0.24});
                    $('.wrap .P3_li .P3_people').width(mw*0.35).height(mh*0.03);
                    $('.wrap .P3_li .P3_people').css({left:(mw*0.41-mw*0.35)/2,top:mh*0.27});
                    $('.wrap .P3_li .P3_votebtn').height(mh*0.05);
                    $('.wrap .P3_li .P3_votebtn').css({left:(mw*0.41-mh*0.05*159/49)/2,top:mh*0.31});

                    $('.wrap .P3_bottom').width(mh*0.33).height(mh*0.04);
                    $('.wrap .P3_bottom').css({left:(mw-mh*0.33)/2,top:mh*0.89});
                    $('.wrap .P3_bottom .P3_upperbtn').height(mh*0.04);
                    $('.wrap .P3_bottom .P3_num1btn').height(mh*0.04);
                    $('.wrap .P3_bottom .P3_num1btn').css({left:(mh*0.33-mh*0.04*58/47)/2});
                    $('.wrap .P3_bottom .P3_lowerbtn').height(mh*0.04);
                break;  
        }
